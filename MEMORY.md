...
- [ADR-0005: Next.js/RLS/Supabase-CLI/Vercel-only architecture](./docs/adr/0005-nextjs-rls-supabase-architecture.md) — Server Actions replace Spring Boot, Postgres RLS for authorization, no ORM, Supabase CLI migrations, Vercel-only deploy
