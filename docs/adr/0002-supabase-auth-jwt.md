...
> **Superseded by [ADR-0005](./0005-nextjs-rls-supabase-architecture.md)**: authorization now happens via Postgres RLS policies instead of application-level JWT verification.
