...
> **Superseded by [ADR-0005](./0005-nextjs-rls-supabase-architecture.md).** The Spring Boot backend was dropped, so Railway is no longer needed; deployment is Vercel-only.
